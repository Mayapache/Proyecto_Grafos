...
class App:
    def __init__(self,grf):
        ...
        self.size = self.weight, self.height = int(1366*.9), int(768*.9) #80% de la pantalla
        self.Grf=grf
    def on_init(self):
        pg.init()
        ...
        pg.display.set_caption('Gephi ñero')  #nombre ventana
    ...
    def on_loop(self):
        ...
        self.cuenta_imag+=1
        pg.image.save(self._display_surf,"C:/Users/Maya Carlos/Documents/Maestria/Primer_semestre/Algoritmos/Imagenes_5/grafito_prueba"+str(self.cuenta_imag)+".jpg")
        
        #Dibuja nuevas posiciones en la superficie
        for i in range(len(self.Grf.Vert)):
            pg.draw.circle(surface,(245,245,245),(self.Grf.Vert[i].Posx,self.Grf.Vert[i].Posy),6) #En donde, colores, posición xy, radio
...
#a=Gmn_Malla(3,3,"Mallita",dirigido=False,pacman=True)

#a=Gmn_Malla(10,10,"Mallita",dirigido=False)


#a=Gnm_Erdo_Renyi(500,200,"Gnm_Erdo_Renyi_n100_m400") #4900
...
#a=Gnm_Erdo_Renyi(100,400,"Gnm_Erdo_Renyi_n100_m400")#4900    LISTOOOO
#a=Gnp_Gilbert(100,.07,"Gnp_Gilbert_n100_p07")   # LISTOOO
#a=Gnr_Geograf_Simple(100,.2,"Gnr_Geograf_Sim_n100_r20")   #LISTOOO
#a=Gnd_Barabasi_Albert(100,5,"Gnd_Barabasi_Albert_n100_d5")  #LISTOOO
#a=Gmn_Malla(10,10,"Gmn_Malla_n7_m7")   #LISTOOO
#a=Dorogovtsev_Mendes(100,"Dorogovtsev_Mendes_100")    #LISTOOO

#a=Gnm_Erdo_Renyi(500,1000,"Gnm_Erdo_Renyi_n500_m1000")  #LISTOOO
#a=Gnp_Gilbert(500,.01,"Gnp_Gilbert_n500_p01")   #LISTOOO
#a=Gnr_Geograf_Simple(500,.07,"Gnr_Geograf_Sim_n500_r07")    #LISTOOO
#a=Gnd_Barabasi_Albert(500,7,"Gnd_Barabasi_Albert_n500_d7")  #LISTOOO
#a=Gmn_Malla(23,22,"Gmn_Malla_n23_m22")   #LISTOOO
...
#antes de cerrarse:
path="C:/Users/Maya Carlos/Documents/Maestria/Primer_semestre/Algoritmos/Imagenes_5/"
...
#Guardar Gif
imageio.mimwrite('C:/Users/Maya Carlos/Documents/Maestria/Primer_semestre/Algoritmos/Gif_5/'+a.Nom+'.gif', img_array, 'GIF', duration=.07)
